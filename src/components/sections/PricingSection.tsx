...
const PricingSection = () => {
  return (
    <section
      id="pricing"
      className="py-24 md:py-32 lg:py-40 bg-industrial text-white px-6 md:px-12 lg:px-24"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-2xl md:text-3xl font-light mb-6 max-w-2xl">
          Transparent pricing for complete IT management
        </p>
        <p className="text-lg opacity-70 mb-12 max-w-2xl">
          All plans include the full bundle: ITAM, Software License Management, Cost Tracking, IT Support, Cloud Services, and Implementation.
        </p>
                ...
                >
                  <TableCell className="font-medium text-white">
                    <div className="flex items-center gap-3">
                      {row.scenario}
                      {row.recommended && (
                        <span className="text-xs px-2 py-1 bg-white text-dark-craft rounded-sm">
                          Recommended
                        </span>
                      )}
                    </div>
          ...
          {pricingData.map((row, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="bg-white/5 p-3 -mx-3">
                  <p className="text-white/50 mb-1 text-xs">Discounted Per Employee</p>
